 ...
 * 
 * @see <a href="https://code.google.com/p/android-wheel/source/browse/trunk/wheel/src/kankan/wheel/widget/WheelRecycle.java">
 *     	https://code.google.com/p/android-wheel/source/browse/trunk/wheel/src/kankan/wheel/widget/WheelRecycle.java
 *     	</a>
 */
class WheelRecycle {
	...
	/**
	 * Recycles items from specified layout. There are saved only items not included to specified range. All the cached items are removed
